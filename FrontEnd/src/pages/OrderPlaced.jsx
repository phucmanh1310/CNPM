        ...
        text-center relative overflow-hidden'>
            ...
            {totalOrders > 1 ? (
                <div className='text-gray-600 max-w-md mb-6'>
                    ...
                    <p className='text-sm'>
                        Each restaurant will prepare their items separately.
                        You can track all orders in the "My Orders" section.
                    </p>
                </div>
            ) : (
            ...
            {orders && orders.length > 0 && (
                <div className='bg-white rounded-lg shadow-md p-4 mb-6 max-w-md w-full'>
                    ...
                    <div className='space-y-2'>
                        {orders.map((order) => (
                            <div key={order._id} className='text-left border-b pb-2 last:border-b-0'>
            ...
            <div className='flex gap-4'>
                ...
                <button className='bg-[#00BFFF] hover:bg-blue-600 text-white px-6 py-3 rounded-lg
                text-lg font-medium transition'
                    onClick={() => {
                        navigate("/my-orders")
                    }}>
