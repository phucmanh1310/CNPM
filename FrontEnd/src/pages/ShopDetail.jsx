...
function ShopDetail() {
  ...
  const shopItems = useMemo(() => {
    return itemsInMyCity?.filter((item) => {
      ...
      return (
        ...
        item.shop === shopId ||
        item.shop?._id?.toString() === shopId
      )
    }) || []
  }, [itemsInMyCity, shopId])
  ...
  const filteredItems = useMemo(() => {
    ...
    return filtered
  }, [shopItems, searchTerm, selectedCategory, priceRange.min, priceRange.max, sortBy, sortOrder])
  const clearFilters = () => {
    setSearchTerm('')
    setSelectedCategory('')
      ...
      <div className="w-screen min-h-screen flex flex-col items-center justify-center bg-[#fff9f6]">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">
            Available shops: {shopsInMyCity?.length || 0}
          </p>
          <button
            onClick={() => navigate('/')}
        ...
        <div className="relative">
          <img
            ...
            onError={(e) => {
              ...
              e.target.src =
                'https://via.placeholder.com/800x300/4F46E5/FFFFFF?text=Shop+Image'
            }}
          />
