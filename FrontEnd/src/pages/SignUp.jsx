...
function SignUp() {
  ...
  const MobileRules = () => (
    <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded-lg">
      <h4 className="text-sm font-semibold text-green-800 mb-2">Mobile Number Requirements:</h4>
    ...
    >
      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            type="text"
            className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:border-orange-500 ${validationErrors.fullName ? 'border-red-500' : ''
              }`}
        ...
        <div className="mb-4">
          ...
          <input
            type="email"
            className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:border-orange-500 ${validationErrors.email ? 'border-red-500' : ''
              }`}
        ...
        <div className="mb-4">
          ...
          <input
            type="tel"
            className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:border-orange-500 ${validationErrors.mobile ? 'border-red-500' : ''
              }`}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              className={`w-full border rounded-lg px-3 py-2 focus:outline-none focus:border-orange-500 ${validationErrors.password ? 'border-red-500' : ''
                }`}
